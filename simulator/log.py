...
class _Log(object):
    ...
    def init_log(self):
        ...
        if FLAGS.schedule == 'gpu-demands':
            ...
            if FLAGS.scheme == 'count':
                ...
                log_writer.writerow(['time', 'job_id', 'num_gpu', 'submit_time', 'start_time', 'end_time', 'executed_time', 'real_executed_time', 'JCT', 'duration', 'pending_time', 'preempt', 'promote'])
        fd.close()
    ...
    def job_complete(self, job, event_time):
        '''
        ['even_time', 'job_id', 'num_gpu', 'submit_time', 'start_time', 'end_time', 'executed time', 'real executed time', 'jct', 'duration', 'pending_time']
        '''
        ...
        if FLAGS.scheme == 'count':
            ...
            if 'job_counter' in job:
                ...
                self.job_list.append([event_time, job['job_id'], job['num_gpu'], job['submit_time'], job['start_time'], job['end_time'], executed_time, real_executed_time, jct, job['duration'], job['pending_time'], job['preempt'], job['promote']])
